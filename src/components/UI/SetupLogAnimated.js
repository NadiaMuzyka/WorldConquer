...
export default function SetupLogAnimated() {
    ...
    if (finished && myTerritories.length > 0) {
        return (
            <div className="fixed left-8 bottom-8 z-30 bg-[#1B2227]/90 px-6 py-3 rounded-xl shadow-xl border-l-4 border-cyan-400">
    ...
    return (
        <div className="fixed left-8 bottom-8 z-30 bg-[#1B2227]/90 px-6 py-3 rounded-xl shadow-xl border-l-4" style={{ borderColor: myColor }}>
